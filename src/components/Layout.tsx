...
const Layout = ({ onLogout, currentUser }: LayoutProps) => {
  ...
  const navigation = [
    ...
    { name: t.fiscal_journal, href: '/fiscal-journal', icon: FileSpreadsheet, roles: ['admin'] },
    { name: 'Gestion des clients', href: '/clients', icon: Users, roles: ['admin'] },
    { name: 'Gestion des crédits', href: '/credits', icon: CreditCard, roles: ['admin'] },
    { name: 'Gestion des retours', href: '/returns', icon: RotateCcw, roles: ['admin', 'employee'] },
